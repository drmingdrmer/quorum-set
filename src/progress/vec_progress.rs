    ...
    QS: QuorumSet<Id = Entry::Id>,
{
    ...
    #[inline(always)]
    pub fn index(&self, target: &Entry::Id) -> Option<usize> {
    ...
    /// Consume this progress tracker and return its entries.
